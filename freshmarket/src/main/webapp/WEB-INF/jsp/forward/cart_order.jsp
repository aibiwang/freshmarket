...
<%@ include file="header.jsp"%>
	...
	<div class="common_list_con clearfix">
		...
		<ul class="goods_list_td clearfix">
			...
			<li class="col03">${(map[sc.goodsId]).goodsName}</li>
			<li class="col04">Kg</li>
			<li class="col05">${(map[sc.goodsId]).saleprice}Kg/元</li>
			<li class="col06">${sc.goodscount }</li>
			<li class="col07">${((map[sc.goodsId]).saleprice)*(sc.goodscount)}元</li>	
		</ul>
	...
	<div class="common_list_con clearfix">
		<div class="settle_con">
			<div class="total_goods_count">共<em>${ShopCartSize}</em>件商品，总金额<b id="totalPrice1">*</b></div>
	...
	$(function(){
		...
		$(".col07").each(function(){
			...
			$('#totalPrice1').html(totalPrice+'元');
			$('#totalPrice2').html(totalPrice+8+'元');
