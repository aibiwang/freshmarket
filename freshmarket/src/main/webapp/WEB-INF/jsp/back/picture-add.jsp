...
<div id="scrollsidebar" class="left_Treeview">
  ...
  <!-- 
   ...
   <div class="type_title">添加商品</div>
	<form action="addGoods.do" method="post" class="form form-horizontal" id="form-article-add">
		...
		<div class=" clearfix cl">
            ...
            <div class="Add_p_s">
			 ...
			 <div class="formControls col-2"><input type="text" class="input-text" value="" placeholder="" id="" name="goodsReservenum" >kg</div>
			</div>
            ...
            <div class="Add_p_s">
			 ...
			 <div class="formControls col-2"><input type="text" class="input-text" value="" placeholder="" id="" name="inprice" >元</div>
			</div>
            <div class="Add_p_s">
             <label class="form-label col-2">销售价格：</label>	
			 <div class="formControls col-2"><input type="text" class="input-text" value="" placeholder="" id="" name="saleprice" >元</div>
			</div>
		...
		<div class="clearfix cl">
			...
			<div class="formControls col-10">
				<textarea name="goodsDesc" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="textarealength(this,200)"></textarea>
