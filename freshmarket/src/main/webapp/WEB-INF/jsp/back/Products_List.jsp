	...
	<div class=" page-content clearfix">
       ...
       <li style="width:90px;"><button type="button" class="btn_search"><i class="icon-search"></i>查询</button></li>
			...
			<div class="border clearfix">
				<span class="l_f"> <a href="TgoodsAdd.do" title="添加商品"
				...
				</span> <span class="r_f">共：<b>${goodtotal}</b>件商品
				</span>
			</div>
			<!--产品列表展示-->
									...
									<tr>
										...
										<c:if test="${!empty listgoods }">
											<td width="25px"><label><input type="checkbox"
													class="ace" name="goodsId"
													value="${listgoods.getGoodsId()}" /><span class="lbl"></span></label></td>
											<td width="80px">${listgoods.getGoodsId()}</td>

											<td height="100px" width="100px"><img height="80px"
												width="80px" src="${listgoods.getGoodsPic() }" /></td>
